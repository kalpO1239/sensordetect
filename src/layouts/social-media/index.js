  ...
  const mockPosts = [
    {
      ...
      handle: "@localnews24",
      content:
        "BREAKING: Fire reported at the downtown shopping mall. Fire department responding. #FireAlert",
    ...
    },
    {
      ...
      handle: "",
      content:
        "Seeing smoke coming from the warehouse district. Anyone know what's happening? Stay safe everyone!",
    ...
    },
    {
      ...
      content:
        "Captured this image of firefighters responding to an incident at the office tower. Heroes at work! #FirstResponders",
    ...
    },
    {
      ...
      handle: "@cityfiredept",
      content:
        "We are currently responding to a fire incident at 123 Main St. Please avoid the area to allow emergency vehicles access.",
    ...
    },
    {
      ...
      handle: "",
      content:
        "ALERT: Small fire reported at the community center. Fire department on scene. Event has been evacuated as a precaution.",
    ...
    },
    {
      ...
      content:
        "High fire danger today due to dry conditions and strong winds. Please exercise caution with any potential ignition sources.",
          ...
          <Grid item xs={12} key={post.id}>
            <Card>
              <MDBox p={3}>
                ...
                <MDBox mt={2}>
                  <MDTypography variant="body1">{post.content}</MDTypography>
                </MDBox>
