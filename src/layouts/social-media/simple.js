...
function SocialMedia() {
  ...
  const posts = [
    {
      ...
      user: "JohnDoe",
      content:
        "Seeing smoke coming from the building on Main St. Anyone know what's happening? #fire #emergency",
    ...
    },
    {
      ...
      user: "photo_master",
      content:
        "Captured this image of smoke rising from the warehouse district. Stay safe everyone! #fire #safety",
    ...
    },
    {
      ...
      user: "news_reporter",
      content:
        "Breaking: Fire reported at 123 Main St. Fire department on scene. #breaking #fire",
    ...
    },
    {
      ...
      content:
        "Alert: Fire reported in the downtown area. Please avoid Main St. and surrounding blocks.",
  ...
  const filteredPosts =
    filter === "all"
      ? posts
      : posts.filter((post) => post.platform.toLowerCase() === filter);
