...
function Trending() {
  ...
  const incidentsByLocationData = {
    labels: ["Office Tower", "Shopping Mall", "Warehouse", "Residential", "Restaurant", "Hotel"],
  ...
  const responseTimeData = {
    ...
    datasets: { label: "Minutes", data: [12, 15, 10, 8, 9, 7, 6, 8, 10, 9, 8, 7] },
  };
            ...
            <Card>
              ...
              >
                ...
                <FormControl sx={{ minWidth: 150, color: "white" }}>
                  <InputLabel id="time-range-label" sx={{ color: "white" }}>Time Range</InputLabel>
                  <Select
                ...
                <TabPanel value={tabValue} index={1}>
                  <MDBox mb={3}>
                    ...
                    <MDTypography variant="body2" color="text" mb={2}>
                      This heat map shows the concentration of fire incidents across the region.
                      Areas with higher incident rates appear in red.
                    </MDTypography>
                    <Card>
